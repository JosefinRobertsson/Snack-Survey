...
const StartScreen = () => {
    ...
    return (
        <>
            <h1>Survey by <span className="capital-letter">Y</span>our<span className="capital-letter">C</span>orner<span className="capital-letter">S</span>tore</h1>
            ...
            <p>-Something witty. YourCornerStore</p>
